...
import { readdirSync, mkdirSync, writeFile, statSync, readFileSync, watch, lstatSync, realpathSync } from 'fs';
...
function collectAddon(graph, initialAddon, addonName, sep$$1) {
    return Promise.all([
        {
            pluginName: 'rollup',
            source: initialAddon
    ...
    function FileWatcher(id, chokidarOptions, dispose) {
        ...
        var handleWatchEvent = function (event) {
            if (event === 'rename' || event === 'unlink') {
                ...
                var contents = readFileSync(id, 'utf-8');
                if (contents !== data) {
                    data = contents;
                    _this.trigger();
                }
...
export { rollup, watch$1 as watch, version$1 as VERSION, Watcher, Task };
