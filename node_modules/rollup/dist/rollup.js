/*
	Rollup.js v0.60.2
	Mon, 11 Jun 2018 06:42:55 GMT - commit 1ed9eecb0e5105cd955e2d48c6930ff6bb629e0c
...
var UNKNOWN_ARRAY_EXPRESSION = {
    ...
    hasEffectsWhenCalledAtPath: function (path$$1, callOptions, options) {
        if (path$$1.length === 1) {
            return hasMemberEffectWhenCalled(arrayMembers, path$$1[0], false, callOptions, options);
        }
        return true;
    },
    someReturnExpressionWhenCalledAtPath: function (path$$1, callOptions, predicateFunction, options) {
        if (path$$1.length === 1) {
            return someMemberReturnExpressionWhenCalled(arrayMembers, path$$1[0], callOptions, predicateFunction, options);
        }
        return true;
    },
...
var UNKNOWN_LITERAL_BOOLEAN = {
    ...
    someReturnExpressionWhenCalledAtPath: function (path$$1, _callOptions, predicateFunction, options) {
        if (path$$1.length === 1) {
            var subPath = path$$1[0];
...
var Variable = /** @class */ (function () {
    ...
    Variable.prototype.getLiteralValueAtPath = function (_path, _options) {
...
var LocalVariable = /** @class */ (function (_super) {
    ...
    LocalVariable.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (!this.isReassigned &&
            ...
            this.init.forEachReturnExpressionWhenCalledAtPath(path$$1, callOptions, callback, options.addCalledNodeAtPathWithOptions(path$$1, this.init, callOptions));
        }
    };
    LocalVariable.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (this.isReassigned ||
            !this.init ||
            path$$1.length > MAX_PATH_DEPTH ||
            options.hasNodeValueBeenRetrievedAtPath(path$$1, this.init)) {
            return UNKNOWN_VALUE;
        }
        return this.init.getLiteralValueAtPath(path$$1, options.addRetrievedNodeValueAtPath(path$$1, this.init));
    };
    ...
    LocalVariable.prototype.reassignPath = function (path$$1, options) {
        if (path$$1.length > MAX_PATH_DEPTH)
            return;
        if (!(this.isReassigned || options.hasNodeBeenAssignedAtPath(path$$1, this))) {
            if (path$$1.length === 0) {
                this.isReassigned = true;
            }
            else if (this.init) {
                this.init.reassignPath(path$$1, options.addAssignedNodeAtPath(path$$1, this));
            }
        }
    };
    LocalVariable.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        ...
        return (this.isReassigned ||
            (this.init &&
                !options.hasNodeBeenCalledAtPathWithOptions(path$$1, this.init, callOptions) &&
                this.init.someReturnExpressionWhenCalledAtPath(path$$1, callOptions, predicateFunction, options.addCalledNodeAtPathWithOptions(path$$1, this.init, callOptions))));
    };
...
function system(magicString, _a, options) {
    var graph = _a.graph, t = _a.indentString, intro = _a.intro, outro = _a.outro, dependencies = _a.dependencies, exports = _a.exports;
    var n = options.compact ? '' : '\n';
    var _ = options.compact ? '' : ' ';
    ...
    exports.forEach(function (expt) {
        if (expt.hoisted)
            functionExports.push("exports('" + expt.exported + "'," + _ + expt.local + ");");
    });
    ...
    wrapperStart += "" + (functionExports.length ? "" + t + t + t + functionExports.join("" + n + t + t + t) + n : '');
    if (intro)
        magicString.prepend(intro);
    if (outro)
        magicString.append(outro);
...
(function (OptionTypes) {
    ...
    OptionTypes[OptionTypes["RETRIEVED_VALUE_NODES"] = 8] = "RETRIEVED_VALUE_NODES";
    OptionTypes[OptionTypes["RETURN_EXPRESSIONS_ACCESSED_AT_PATH"] = 9] = "RETURN_EXPRESSIONS_ACCESSED_AT_PATH";
    OptionTypes[OptionTypes["RETURN_EXPRESSIONS_ASSIGNED_AT_PATH"] = 10] = "RETURN_EXPRESSIONS_ASSIGNED_AT_PATH";
    OptionTypes[OptionTypes["RETURN_EXPRESSIONS_CALLED_AT_PATH"] = 11] = "RETURN_EXPRESSIONS_CALLED_AT_PATH";
...
var ExecutionPathOptions = /** @class */ (function () {
    ...
    ExecutionPathOptions.prototype.addRetrievedNodeValueAtPath = function (path$$1, node) {
        return this.setIn([OptionTypes.RETRIEVED_VALUE_NODES, node].concat(path$$1, [RESULT_KEY]), true);
    };
    ...
    ExecutionPathOptions.prototype.hasNodeValueBeenRetrievedAtPath = function (path$$1, node) {
        return this.optionValues.getIn([OptionTypes.RETRIEVED_VALUE_NODES, node].concat(path$$1, [RESULT_KEY]));
    };
...
var NodeBase = /** @class */ (function () {
    ...
    NodeBase.prototype.getLiteralValueAtPath = function (_path, _options) {
        return UNKNOWN_VALUE;
    };
    ...
    ArgumentsVariable.prototype.reassignPath = function (path$$1, options) {
        ...
        if (path$$1.length > 0) {
            if (firstArgNum >= 0 && this.parameters[firstArgNum]) {
                this.parameters[firstArgNum].reassignPath(path$$1.slice(1), options);
            }
        }
    };
...
var ReturnValueScope = /** @class */ (function (_super) {
    ...
    ReturnValueScope.prototype.bind = function () {
        this.bound = true;
...
var FunctionNode = /** @class */ (function (_super) {
    ...
    FunctionNode.prototype.hasEffectsWhenAccessedAtPath = function (path$$1) {
        ...
        return path$$1.length > 2 || path$$1[0] !== 'prototype' || this.isPrototypeReassigned;
    };
    ...
    FunctionNode.prototype.reassignPath = function (path$$1) {
        if (path$$1.length === 1 && path$$1[0] === 'prototype') {
...
var Identifier$1 = /** @class */ (function (_super) {
    ...
    Identifier$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (!this.bound)
            this.bind();
    ...
    Identifier$$1.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1, options);
        }
        return UNKNOWN_VALUE;
    };
    ...
    Identifier$$1.prototype.reassignPath = function (path$$1, options) {
        if (!this.bound)
            this.bind();
        if (this.variable !== null) {
            if (path$$1.length === 0 &&
    ...
    Identifier$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (this.variable) {
...
var ArrayExpression$1 = /** @class */ (function (_super) {
    ...
    ArrayExpression.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (path$$1.length === 1) {
            return someMemberReturnExpressionWhenCalled(arrayMembers, path$$1[0], callOptions, predicateFunction, options);
        }
        return true;
    ...
    ArrayPattern.prototype.reassignPath = function (path$$1, options) {
        if (path$$1.length === 0) {
            for (var _i = 0, _a = this.elements; _i < _a.length; _i++) {
                var element = _a[_i];
                if (element !== null) {
                    element.reassignPath(path$$1, options);
                }
            }
        }
    };
...
var ArrowFunctionExpression$1 = /** @class */ (function (_super) {
    ...
    ArrowFunctionExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        path$$1.length === 0 &&
            this.scope.forEachReturnExpressionWhenCalled(callOptions, callback, options);
    };
    ...
    ArrowFunctionExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        return (path$$1.length > 0 ||
            this.scope.someReturnExpressionWhenCalled(callOptions, predicateFunction, options));
    };
...
var BinaryExpression$1 = /** @class */ (function (_super) {
    ...
    BinaryExpression.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var leftValue = this.left.getLiteralValueAtPath(EMPTY_PATH, options);
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        var rightValue = this.right.getLiteralValueAtPath(EMPTY_PATH, options);
...
var CallExpression$1 = /** @class */ (function (_super) {
    ...
    CallExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        this.callee.forEachReturnExpressionWhenCalledAtPath([], this.callOptions, function (innerOptions, node) {
    ...
    CallExpression.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        return (path$$1.length > 0 &&
            ...
            this.callee.someReturnExpressionWhenCalledAtPath([], this.callOptions, function (innerOptions, node) {
    ...
    CallExpression.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        return this.callee.someReturnExpressionWhenCalledAtPath([], this.callOptions, function (innerOptions, node) {
...
var ConditionalExpression$1 = /** @class */ (function (_super) {
    ...
    ConditionalExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        var testValue = this.hasUnknownTestValue ? UNKNOWN_VALUE : this.getTestValue(options);
    ...
    ConditionalExpression.prototype.getLiteralValueAtPath = function (path$$1, options) {
        var testValue = this.hasUnknownTestValue ? UNKNOWN_VALUE : this.getTestValue(options);
        if (testValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        return testValue
            ? this.consequent.getLiteralValueAtPath(path$$1, options)
            : this.alternate.getLiteralValueAtPath(path$$1, options);
    };
    ...
    ConditionalExpression.prototype.include = function () {
        this.included = true;
        var testValue = this.hasUnknownTestValue
            ? UNKNOWN_VALUE
    ...
    ConditionalExpression.prototype.getTestValue = function (options) {
        if (this.hasUnknownTestValue)
            return UNKNOWN_VALUE;
        var value = this.test.getLiteralValueAtPath(EMPTY_PATH, options);
...
var IfStatement$1 = /** @class */ (function (_super) {
    ...
    IfStatement.prototype.getTestValue = function (options) {
        if (this.hasUnknownTestValue)
            return UNKNOWN_VALUE;
        var value = this.test.getLiteralValueAtPath(EMPTY_PATH, options);
        if (value === UNKNOWN_VALUE) {
...
var Literal$1 = /** @class */ (function (_super) {
    ...
    Literal$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (path$$1.length === 1) {
            return someMemberReturnExpressionWhenCalled(this.members, path$$1[0], callOptions, predicateFunction, options);
        }
        return true;
    };
    return Literal$$1;
...
var LogicalExpression$1 = /** @class */ (function (_super) {
    ...
    LogicalExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        var leftValue = this.hasUnknownLeftValue ? UNKNOWN_VALUE : this.getLeftValue(options);
        if (leftValue === UNKNOWN_VALUE) {
    ...
    LogicalExpression.prototype.getLiteralValueAtPath = function (path$$1, options) {
        var leftValue = this.hasUnknownLeftValue ? UNKNOWN_VALUE : this.getLeftValue(options);
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        if (this.isOrExpression ? leftValue : !leftValue)
            return leftValue;
        return this.right.getLiteralValueAtPath(path$$1, options);
    };
    ...
    LogicalExpression.prototype.include = function () {
        this.included = true;
        var leftValue = this.hasUnknownLeftValue
            ? UNKNOWN_VALUE
    ...
    LogicalExpression.prototype.getLeftValue = function (options) {
        if (this.hasUnknownLeftValue)
            return UNKNOWN_VALUE;
        var value = this.left.getLiteralValueAtPath(EMPTY_PATH, options);
        if (value === UNKNOWN_VALUE) {
...
var MemberExpression$1 = /** @class */ (function (_super) {
    ...
    MemberExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (!this.bound)
            this.bind();
        if (this.variable !== null) {
            this.variable.forEachReturnExpressionWhenCalledAtPath(path$$1, callOptions, callback, options);
            ...
            this.object.forEachReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), callOptions, callback, options);
        }
    };
    MemberExpression$$1.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1, options);
        }
        return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), options);
    };
    ...
    MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        ...
        return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), callOptions, options);
    };
    ...
    MemberExpression$$1.prototype.reassignPath = function (path$$1, options) {
        if (!this.bound)
            this.bind();
        if (path$$1.length === 0)
        ...
        if (this.variable) {
            ...
            this.object.reassignPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), options);
        }
    };
    ...
    MemberExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (this.variable) {
            return this.variable.someReturnExpressionWhenCalledAtPath(path$$1, callOptions, predicateFunction, options);
        }
        return this.object.someReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path$$1), callOptions, predicateFunction, options);
    };
    ...
    MemberExpression$$1.prototype.getComputedKey = function (options) {
        var value = this.property.getLiteralValueAtPath(EMPTY_PATH, options);
...
var ObjectExpression$1 = /** @class */ (function (_super) {
    ...
    ObjectExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (path$$1.length === 0)
            return;
        var properties = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, options).properties;
        for (var _i = 0, properties_1 = properties; _i < properties_1.length; _i++) {
            var property = properties_1[_i];
            property.forEachReturnExpressionWhenCalledAtPath(path$$1.slice(1), callOptions, callback, options);
        }
    };
    ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path$$1, options) {
        var key = path$$1[0];
        if (path$$1.length === 0 ||
            this.hasUnknownReassignedProperty ||
            (typeof key === 'string' && this.reassignedPaths[key]))
            return UNKNOWN_VALUE;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!hasCertainHit || properties.length > 1)
            return UNKNOWN_VALUE;
        return properties[0].getLiteralValueAtPath(path$$1.slice(1), options);
    };
    ObjectExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        if (path$$1.length > 1 &&
            ...
            return true;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (path$$1.length > 1 && !hasCertainHit)
            return true;
    ...
    ObjectExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        if (path$$1.length > 1 &&
            (this.hasUnknownReassignedProperty || (typeof key === 'string' && this.reassignedPaths[key])))
            return true;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], path$$1.length === 1 ? PROPERTY_KINDS_WRITE : PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (path$$1.length > 1 && !hasCertainHit)
            return true;
        var subPath = path$$1.slice(1);
        for (var _i = 0, properties_3 = properties; _i < properties_3.length; _i++) {
            var property = properties_3[_i];
            if ((path$$1.length > 1 || property.kind === 'set') &&
    ...
    ObjectExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        ...
        if (path$$1.length === 0 ||
            ...
            (typeof key === 'string' && this.reassignedPaths[key]))
            return true;
        var _a = this.getPossiblePropertiesWithName(key, PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!(hasCertainHit || (path$$1.length === 1 && typeof key === 'string' && objectMembers[key])))
            return true;
        var subPath = path$$1.slice(1);
        ...
        if (path$$1.length === 1 && typeof key === 'string' && objectMembers[key])
    ...
    ObjectExpression$$1.prototype.reassignPath = function (path$$1, options) {
        if (path$$1.length === 0)
            return;
        if (path$$1.length === 1) {
    ...
    ObjectExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        var key = path$$1[0];
        if (path$$1.length === 0 ||
            this.hasUnknownReassignedProperty ||
            (typeof key === 'string' && this.reassignedPaths[key]))
    ...
    ObjectExpression$$1.prototype.getPossiblePropertiesWithName = function (name, kinds, options) {
        if (name === UNKNOWN_KEY) {
        ...
        for (var index = this.properties.length - 1; index >= 0; index--) {
            ...
            if (property.computed) {
                var value = property.key.getLiteralValueAtPath(EMPTY_PATH, options);
            ...
            else if ((property.key instanceof Identifier$1 && property.key.name === name) ||
                (property.key instanceof Literal$1 && property.key.value === name)) {
                properties.push(property);
                hasCertainHit = true;
                break;
            }
...
var ObjectPattern$1 = /** @class */ (function (_super) {
    ...
    ObjectPattern.prototype.reassignPath = function (path$$1, options) {
        if (path$$1.length === 0) {
            for (var _i = 0, _a = this.properties; _i < _a.length; _i++) {
                var property = _a[_i];
                property.reassignPath(path$$1, options);
            }
        }
    };
...
var Property$1 = /** @class */ (function (_super) {
    __extends(Property$$1, _super);
    function Property$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Property$$1.prototype.declare = function (kind, _init) {
        this.value.declare(kind, UNKNOWN_EXPRESSION);
    };
    Property$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (this.kind === 'get') {
            this.value.forEachReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
                return node.forEachReturnExpressionWhenCalledAtPath(path$$1, callOptions, callback, innerOptions);
            }, options);
        }
        else {
    ...
    Property$$1.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (this.kind === 'get') {
            return UNKNOWN_VALUE;
        }
        return this.value.getLiteralValueAtPath(path$$1, options);
    };
    Property$$1.prototype.hasEffects = function (options) {
        return this.key.hasEffects(options) || this.value.hasEffects(options);
    };
    Property$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        var _this = this;
        if (this.kind === 'get') {
            return (this.value.hasEffectsWhenCalledAtPath([], this.accessorCallOptions, options.getHasEffectsWhenCalledOptions()) ||
                (!options.hasReturnExpressionBeenAccessedAtPath(path$$1, this) &&
                    this.value.someReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
                        return node.hasEffectsWhenAccessedAtPath(path$$1, innerOptions.addAccessedReturnExpressionAtPath(path$$1, _this));
                    }, options)));
        }
        return this.value.hasEffectsWhenAccessedAtPath(path$$1, options);
    };
    Property$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        var _this = this;
        if (this.kind === 'get') {
            return (path$$1.length === 0 ||
                this.value.someReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
    ...
    Property$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        var _this = this;
        if (this.kind === 'get') {
            return (this.value.hasEffectsWhenCalledAtPath([], this.accessorCallOptions, options.getHasEffectsWhenCalledOptions()) ||
    ...
    Property$$1.prototype.initialise = function () {
        this.included = false;
    ...
    Property$$1.prototype.reassignPath = function (path$$1, options) {
        var _this = this;
        if (this.kind === 'get') {
            path$$1.length > 0 &&
                this.value.forEachReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
    ...
    Property$$1.prototype.render = function (code, options) {
        if (!this.shorthand) {
            this.key.render(code, options);
        }
        this.value.render(code, options);
    };
    Property$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (this.kind === 'get') {
            return (this.value.hasEffectsWhenCalledAtPath([], this.accessorCallOptions, options.getHasEffectsWhenCalledOptions()) ||
                this.value.someReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
                    return node.someReturnExpressionWhenCalledAtPath(path$$1, callOptions, predicateFunction, innerOptions);
...
var RestElement$1 = /** @class */ (function (_super) {
    ...
    RestElement.prototype.declare = function (kind, _init) {
    ...
    RestElement.prototype.reassignPath = function (path$$1, options) {
        path$$1.length === 0 && this.argument.reassignPath(EMPTY_PATH, options);
    };
    return RestElement;
}(NodeBase));
...
var SequenceExpression$1 = /** @class */ (function (_super) {
    ...
    SequenceExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        this.expressions[this.expressions.length - 1].forEachReturnExpressionWhenCalledAtPath(path$$1, callOptions, callback, options);
    };
    SequenceExpression.prototype.getLiteralValueAtPath = function (path$$1, options) {
        return this.expressions[this.expressions.length - 1].getLiteralValueAtPath(path$$1, options);
    };
    ...
    SequenceExpression.prototype.reassignPath = function (path$$1, options) {
        if (path$$1.length > 0)
            this.expressions[this.expressions.length - 1].reassignPath(path$$1, options);
    };
...
var UnaryExpression$1 = /** @class */ (function (_super) {
    ...
    UnaryExpression.prototype.getLiteralValueAtPath = function (path$$1, options) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var argumentValue = this.argument.getLiteralValueAtPath(EMPTY_PATH, options);
...
var VariableDeclaration$1 = /** @class */ (function (_super) {
    ...
    VariableDeclaration$$1.prototype.reassignPath = function (_path, _options) {
        for (var _i = 0, _a = this.declarations; _i < _a.length; _i++) {
            var declarator = _a[_i];
...
var Chunk$1 = /** @class */ (function () {
    function Chunk(graph, orderedModules) {
        ...
        if (this.entryModule)
            this.name = makeLegal(path.basename(this.entryModule.chunkAlias || this.orderedModules[0].chunkAlias || this.entryModule.id));
        else
    ...
    Chunk.prototype.finaliseDynamicImports = function () {
        for (var i = 0; i < this.orderedModules.length; i++) {
            ...
            for (var j = 0; j < module.dynamicImportResolutions.length; j++) {
                ...
                if (resolution instanceof Module) {
                    if (resolution.chunk !== this) {
                        var relPath = normalize(path.relative(path.dirname(this.id), resolution.chunk.id));
    ...
    Chunk.prototype.generateIdPreserveModules = function (preserveModulesRelativeDir) {
        return (this.id = normalize(path.relative(preserveModulesRelativeDir, this.entryModule.id)));
    };
...
function transform(graph, source, id, plugins) {
    ...
    plugins.forEach(function (plugin) {
        ...
        promise = promise.then(function (previous) {
            return Promise.resolve()
                .then(function () {
                var context = createPluginTransformContext(graph, plugin, id, previous);
...
var Graph = /** @class */ (function () {
    function Graph(options) {
        ...
        this.pluginContext = __assign({ isExternal: undefined, resolveId: undefined, parse: this.contextParse, warn: function (warning) {
                if (typeof warning === 'string')
                    warning = { message: warning };
                _this.warn(warning);
            }, error: function (err) {
        ...
        this.handleMissingExport = firstSync(this.plugins
            ...
            .filter(Boolean)
            .map(function (missingExport) {
            return function (exportName, importingModule, importedModule, importerStart) {
                return missingExport.call(_this.pluginContext, importingModule.id, exportName, importedModule, importerStart);
            };
        })
    ...
    Graph.prototype.analyseExecution = function (entryModules, graphColouring, inlineDynamicImports, chunkModules) {
        ...
        if (graphColouring && chunkModules) {
            for (var _i = 0, _a = Object.keys(chunkModules); _i < _a.length; _i++) {
                var chunkName = _a[_i];
                curEntryHash = randomUint8Array(10);
                for (var _b = 0, _c = chunkModules[chunkName]; _b < _c.length; _b++) {
                    curEntry = _c[_b];
                    if (curEntry.chunkAlias) {
                        error({
                            code: 'INVALID_CHUNK',
                            message: "Cannot assign " + path.relative(process.cwd(), curEntry.id) + " to the \"" + chunkName + "\" chunk as it is already in the \"" + curEntry.chunkAlias + "\" chunk.\nTry defining \"" + chunkName + "\" first in the manualChunks definitions of the Rollup configuration."
                        });
                    }
                    curEntry.chunkAlias = chunkName;
                    parents = (_d = {}, _d[curEntry.id] = null, _d);
                    visit(curEntry);
                }
            }
        }
        for (var _e = 0, entryModules_3 = entryModules; _e < entryModules_3.length; _e++) {
            curEntry = entryModules_3[_e];
            curEntry.isEntryPoint = true;
            curEntryHash = randomUint8Array(10);
            parents = (_f = {}, _f[curEntry.id] = null, _f);
            visit(curEntry);
        }
        // new items can be added during this loop
        for (var _g = 0, dynamicImports_2 = dynamicImports; _g < dynamicImports_2.length; _g++) {
            curEntry = dynamicImports_2[_g];
            if (curEntry.isEntryPoint)
                continue;
            if (!inlineDynamicImports)
                curEntry.isEntryPoint = true;
            curEntryHash = randomUint8Array(10);
            parents = (_h = {}, _h[curEntry.id] = null, _h);
            visit(curEntry);
        }
    ...
    Graph.prototype.fetchAllDependencies = function (module) {
        ...
        return Promise.all(module.sources.map(function (source) {
            ...
            return (resolvedId ? Promise.resolve(resolvedId) : _this.resolveId(source, module.id)).then(function (resolvedId) {
                ...
                var isExternal = _this.isExternal.call(_this.pluginContext, externalId, module.id, true);
...
var isExtglob$4 = function isExtglob(str) {
  return typeof str === 'string'
    && /[@?!+*]\(/.test(str);
};
...
var Watcher = /** @class */ (function (_super) {
    ...
    function Watcher(configs) {
        ...
        _this.dirty = true;
        _this.running = false;
        _this.tasks = ensureArray(configs).map(function (config) { return new Task(_this, config); });
...
var Task = /** @class */ (function () {
    ...
    Task.prototype.run = function () {
        ...
        return rollup(options)
            ...
            result.cache.modules.forEach(function (module) {
            ...
            if (_this.cache) {
                ...
                if (_this.cache.modules) {
                    _this.cache.modules.forEach(function (module) { return _this.watchFile(module.id); });
                }
            }
            throw error;
        });
