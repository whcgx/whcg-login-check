...
(function (global, factory) {
  ...
  var LocalVariable = /** @class */ (function (_super) {
      ...
      LocalVariable.prototype.getLiteralValueAtPath = function (path, options) {
          if (this.isReassigned ||
              !this.init ||
              path.length > MAX_PATH_DEPTH ||
  ...
  var ExecutionPathOptions = /** @class */ (function () {
      ...
      ExecutionPathOptions.prototype.addRetrievedNodeValueAtPath = function (path, node) {
          return this.setIn([OptionTypes.RETRIEVED_VALUE_NODES, node].concat(path, [RESULT_KEY]), true);
      };
      ...
      ExecutionPathOptions.prototype.hasNodeValueBeenRetrievedAtPath = function (path, node) {
          return this.optionValues.getIn([OptionTypes.RETRIEVED_VALUE_NODES, node].concat(path, [RESULT_KEY]));
      };
  ...
  var FunctionNode = /** @class */ (function (_super) {
      ...
      FunctionNode.prototype.reassignPath = function (path) {
  ...
  var Identifier$1 = /** @class */ (function (_super) {
      ...
      Identifier$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          if (!this.bound)
              this.bind();
      ...
      Identifier$$1.prototype.getLiteralValueAtPath = function (path, options) {
          if (this.variable !== null) {
      ...
      Identifier$$1.prototype.reassignPath = function (path, options) {
          if (!this.bound)
              this.bind();
          if (this.variable !== null) {
              if (path.length === 0 &&
      ...
      Identifier$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          if (this.variable) {
  ...
  var ArrowFunctionExpression$1 = /** @class */ (function (_super) {
      ...
      ArrowFunctionExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          path.length === 0 &&
              this.scope.forEachReturnExpressionWhenCalled(callOptions, callback, options);
      };
      ...
      ArrowFunctionExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          return (path.length > 0 ||
              this.scope.someReturnExpressionWhenCalled(callOptions, predicateFunction, options));
      };
  ...
  var BinaryExpression$1 = /** @class */ (function (_super) {
      ...
      BinaryExpression.prototype.getLiteralValueAtPath = function (path, options) {
          if (path.length > 0)
              return UNKNOWN_VALUE;
  ...
  var ConditionalExpression$1 = /** @class */ (function (_super) {
      ...
      ConditionalExpression.prototype.getLiteralValueAtPath = function (path, options) {
          var testValue = this.hasUnknownTestValue ? UNKNOWN_VALUE : this.getTestValue(options);
  ...
  var Literal$1 = /** @class */ (function (_super) {
      ...
      Literal$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          if (path.length === 1) {
  ...
  var LogicalExpression$1 = /** @class */ (function (_super) {
      ...
      LogicalExpression.prototype.getLiteralValueAtPath = function (path, options) {
          var leftValue = this.hasUnknownLeftValue ? UNKNOWN_VALUE : this.getLeftValue(options);
          if (leftValue === UNKNOWN_VALUE)
              return UNKNOWN_VALUE;
  ...
  var MemberExpression$1 = /** @class */ (function (_super) {
      ...
      MemberExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          if (!this.bound)
              this.bind();
          if (this.variable !== null) {
              this.variable.forEachReturnExpressionWhenCalledAtPath(path, callOptions, callback, options);
              ...
              this.object.forEachReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), callOptions, callback, options);
          }
      };
      MemberExpression$$1.prototype.getLiteralValueAtPath = function (path, options) {
          if (this.variable !== null) {
              return this.variable.getLiteralValueAtPath(path, options);
          }
          return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), options);
      };
      ...
      MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
          ...
          return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), options);
      };
      MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
          if (this.variable !== null) {
              return this.variable.hasEffectsWhenAssignedAtPath(path, options);
          }
          return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), options);
      };
      MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
          ...
          return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), callOptions, options);
      };
      ...
      MemberExpression$$1.prototype.reassignPath = function (path, options) {
          if (!this.bound)
              this.bind();
          if (path.length === 0)
          ...
          if (this.variable) {
              ...
              this.object.reassignPath([this.propertyKey || this.getComputedKey(options)].concat(path), options);
          }
      };
      ...
      MemberExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          if (this.variable) {
              return this.variable.someReturnExpressionWhenCalledAtPath(path, callOptions, predicateFunction, options);
          }
          return this.object.someReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(options)].concat(path), callOptions, predicateFunction, options);
      };
  ...
  var ObjectExpression$1 = /** @class */ (function (_super) {
      ...
      ObjectExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          if (path.length === 0)
              return;
          var properties = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ, options).properties;
          for (var _i = 0, properties_1 = properties; _i < properties_1.length; _i++) {
              var property = properties_1[_i];
              property.forEachReturnExpressionWhenCalledAtPath(path.slice(1), callOptions, callback, options);
          }
      };
      ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path, options) {
          var key = path[0];
          if (path.length === 0 ||
              this.hasUnknownReassignedProperty ||
              (typeof key === 'string' && this.reassignedPaths[key]))
              return UNKNOWN_VALUE;
          var _a = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
      ...
      ObjectExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
          ...
          if (path.length > 1 &&
              (this.hasUnknownReassignedProperty || (typeof key === 'string' && this.reassignedPaths[key])))
              return true;
          var _a = this.getPossiblePropertiesWithName(path[0], path.length === 1 ? PROPERTY_KINDS_WRITE : PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
          if (path.length > 1 && !hasCertainHit)
              return true;
          var subPath = path.slice(1);
      ...
      ObjectExpression$$1.prototype.reassignPath = function (path, options) {
          if (path.length === 0)
              return;
          if (path.length === 1) {
      ...
      ObjectExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          var key = path[0];
          if (path.length === 0 ||
              this.hasUnknownReassignedProperty ||
              (typeof key === 'string' && this.reassignedPaths[key]))
  ...
  var Property$1 = /** @class */ (function (_super) {
      ...
      Property$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          if (this.kind === 'get') {
      ...
      Property$$1.prototype.getLiteralValueAtPath = function (path, options) {
          if (this.kind === 'get') {
              return UNKNOWN_VALUE;
          }
      ...
      Property$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
          var _this = this;
          if (this.kind === 'get') {
      ...
      Property$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
          var _this = this;
          if (this.kind === 'get') {
              return (path.length === 0 ||
                  this.value.someReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
      ...
      Property$$1.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
          var _this = this;
          if (this.kind === 'get') {
              return (this.value.hasEffectsWhenCalledAtPath([], this.accessorCallOptions, options.getHasEffectsWhenCalledOptions()) ||
      ...
      Property$$1.prototype.reassignPath = function (path, options) {
          var _this = this;
          if (this.kind === 'get') {
              path.length > 0 &&
                  this.value.forEachReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
      ...
      Property$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
          if (this.kind === 'get') {
              return (this.value.hasEffectsWhenCalledAtPath([], this.accessorCallOptions, options.getHasEffectsWhenCalledOptions()) ||
                  this.value.someReturnExpressionWhenCalledAtPath([], this.accessorCallOptions, function (innerOptions, node) {
                      return node.someReturnExpressionWhenCalledAtPath(path, callOptions, predicateFunction, innerOptions);
  ...
  var SequenceExpression$1 = /** @class */ (function (_super) {
      ...
      SequenceExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
          this.expressions[this.expressions.length - 1].forEachReturnExpressionWhenCalledAtPath(path, callOptions, callback, options);
      };
      SequenceExpression.prototype.getLiteralValueAtPath = function (path, options) {
      ...
      SequenceExpression.prototype.reassignPath = function (path, options) {
          if (path.length > 0)
  ...
  var UnaryExpression$1 = /** @class */ (function (_super) {
      ...
      UnaryExpression.prototype.getLiteralValueAtPath = function (path, options) {
          if (path.length > 0)
              return UNKNOWN_VALUE;
